...
public class MemberMybatisController {
	...
	public ModelAndView insertresult(MemberDTO dto) {
		...
		int result = service.insertmember(dto);//id,phone,email �ߺ� �Ұ���
		ModelAndView mv = new ModelAndView();
	...
	public ModelAndView updateresult(MemberDTO dto) {//id(����), name, address �Է�
		int result = service.updatemember(dto);//id,phone,email �ߺ� �Ұ���
		ModelAndView mv = new ModelAndView();
		mv.addObject("result", result); //int
	...
	public String deleteresult(String id) {
		...
		if(result == 1) {
			return "redirect:/membermybatislist"; //��Ʈ�ѷ����� url���εȸ޼ҵ� ȣ��(ȸ������Ʈ)	
		}
		return "redirect:/membermybatisinsert";//��Ʈ�ѷ����� url���εȸ޼ҵ� ȣ��(������)
	}
}
